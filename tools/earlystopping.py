"""
Ref: https://github.com/TianBian95/BiGCN/blob/master/tools/earlystopping.py
"""
...
class EarlyStopping:
    """Early stops the training if validation loss doesn't improve after the given patience."""
